...
const WhyChooseUs = () => {
  return (
    <div className="w-full py-16 px-4 bg-gradient-to-b from-[#1C1C1E] to-[#2A2A2E]"> {/* Matched gradient from chair page */}
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 mt-10 md:mt-0 relative">
          ...
          {/* Main Image */}
          <div className="w-full h-[500px] bg-[#2C2C30] relative z-10 rounded-2xl overflow-hidden border border-gray-700"> {/* Matched styling from product cards */}
            <img 
